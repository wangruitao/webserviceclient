 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://service.org.template.com/", wsdlLocation = "http://localhost:8099/webservice/soap/user?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://service.org.template.com/", "UserServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8099/webservice/soap/user?wsdl");
    ...
    public UserService getUserServiceImplPort() {
        return super.getPort(new QName("http://service.org.template.com/", "UserServiceImplPort"), UserService.class);
    }
    ...
    public UserService getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.org.template.com/", "UserServiceImplPort"), UserService.class, features);
    }
